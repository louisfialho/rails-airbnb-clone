...
30.times do
  flat = Flat.new(host:louis, title: Faker::Address.street_name, description: "Really nice flat in #{:location}", location: "London", price: rand(100.1000), image_url: "https://dqav65i4xqidd.cloudfront.net/app/uploads/20180519094708/t2-sete-rios-2.png", longitude: Faker::Address.longitude, latitude: Faker::Address.latitude, address: Faker::Address.full_address)
  flat.save!
end
